...
const Glib::RefPtr<AddServer> injector::inject_add_server_box(
    ...
    return Glib::RefPtr<AddServer>(add_server_builder->get_widget_derived<AddServer>(add_server_builder, "addServerBox", ip_address, port, join_button, network_vm));
}