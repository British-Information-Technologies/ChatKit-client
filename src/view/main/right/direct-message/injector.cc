...
Gtk::Box* injector::inject_direct_message_box(view::WorkerObserver* send_message) {
    ...
    return direct_message_builder->get_widget_derived<DirectMessage>(direct_message_builder, "directMessageBox", message_entry);
}